...
// 計時テスト(T-009)は v8 計装で約 7 倍遅くなり実時間を測れないため、
// カバレッジ付き本体と計装なし計時の二段で回す(loop_002 VERIF-FALSE)
runStep("test", "npx vitest run --coverage --exclude src/core/__tests__/timing.test.ts");
runStep("timing", "npx vitest run src/core/__tests__/timing.test.ts");
